...
<tr>
<td width = "208" height = "30" bgcolor = "#FFFF99"><p align = "right"> * 아이디 </p></td>
...
function chk_id()
{
	if(user_form.fuserid.value=""){
		...
		window.open('id_chk.php?fuser='+user_form.fuserid.value,'IDwin', 'width=400, height = 200');
	}
}
</script>
</td>
...
<td width = "80%"><input type = "password" name = "fpasswd" size = "13" maxlength = "13">
...
<input type = "submit" name = "smt" value = " <<기입하기 "> &nbsp;&nbsp;&nbsp;
